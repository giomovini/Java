...
public class Principal {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//criando um agente
			agentController = contController.createNewAgent("Agente_0", "comportamento.ExemploComportamento", argumentos);
			agentController.start();
			
			//adicionando outro agente
			agentController = contController.acceptNewAgent("Agente_1", new ExemploComportamento());
			agentController.start();
